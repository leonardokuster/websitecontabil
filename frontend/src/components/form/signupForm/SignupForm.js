...
import { TextField, Button, Stepper, Step, StepLabel, Box, FormControl, FormControlLabel, Checkbox, Divider } from '@mui/material';
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && (
            ...
            >
              <FormControlLabel
                control={
                  <Checkbox name="possuiEmpresa" checked={formik.values.possuiEmpresa}
                    onChange={formik.handleChange} />
                }
