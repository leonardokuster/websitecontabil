...
userRoutes
    ...
    .delete("/:id", authMiddleware(), UserController.removerUsuario) // DELETE /users/:userId
    .patch("/:id/tipo", authMiddleware(["admin"]), UserController.atualizarTipoUsuario) // PATCH /users/:userId/tipo
    .put("/changePassword/:id", authMiddleware(), UserController.alterarSenha); // PUT /users/changePassword/:userId
